...
public:
    ...
    void setUnderEncryptedRoot(bool underEncryptedRoot)
    {
        _underEncryptedRoot = underEncryptedRoot;
    }

    bool underEncryptedRoot() const
    {
        return _underEncryptedRoot;
    }
...
private:
    ...
    bool _underEncryptedRoot = false; // this directory is encrypted or is within the tree of directories with root directory encrypted
